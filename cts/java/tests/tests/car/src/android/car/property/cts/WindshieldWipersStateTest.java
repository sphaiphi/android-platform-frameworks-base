...
public class WindshieldWipersStateTest {
    ...
    public void testAllWindshieldWipersStatesAreMappedInToString() {
        ...
        for (Integer windshieldWipersState : windshieldWipersStates) {
            String windshieldWipersStateString =
                    WindshieldWipersState.toString(windshieldWipersState);
            assertWithMessage("%s starts with 0x", windshieldWipersStateString)
                    .that(windshieldWipersStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
