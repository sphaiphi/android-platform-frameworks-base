...
public class WindshieldWipersSwitchTest {
    ...
    public void testAllWindshieldWipersSwitchesAreMappedInToString() {
        ...
        for (Integer windshieldWipersSwitch : windshieldWipersSwitches) {
            String windshieldWipersSwitchString =
                    WindshieldWipersSwitch.toString(windshieldWipersSwitch);
            assertWithMessage("%s starts with 0x", windshieldWipersSwitchString)
                    .that(windshieldWipersSwitchString.startsWith("0x"))
                    .isFalse();
        }
    }
}
