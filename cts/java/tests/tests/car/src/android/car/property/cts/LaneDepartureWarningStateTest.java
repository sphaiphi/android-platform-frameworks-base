...
public class LaneDepartureWarningStateTest {
    ...
    public void testAllLaneDepartureWarningStatesAreMappedInToString() {
        List<Integer> laneDepartureWarningStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(LaneDepartureWarningState.class);
        for (Integer laneDepartureWarningState : laneDepartureWarningStates) {
            String laneDepartureWarningStateString =
                    LaneDepartureWarningState.toString(laneDepartureWarningState);
            assertWithMessage("%s starts with 0x", laneDepartureWarningStateString)
                    .that(laneDepartureWarningStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
