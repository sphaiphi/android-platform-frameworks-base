...
public class VehicleLightStateTest {
    ...
    public void testToString() {
        assertThat(VehicleLightState.toString(VehicleLightState.STATE_OFF)).isEqualTo("STATE_OFF");
        assertThat(VehicleLightState.toString(VehicleLightState.STATE_ON)).isEqualTo("STATE_ON");
    ...
    public void testAllVehicleLightStatesAreMappedInToString() {
        List<Integer> vehicleLightStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(VehicleLightState.class);
        for (Integer vehicleLightState : vehicleLightStates) {
            ...
            assertWithMessage("%s starts with 0x", vehicleLightStateString)
                    .that(vehicleLightStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
