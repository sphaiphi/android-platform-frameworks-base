...
public class ElectronicStabilityControlStateTest {
    ...
    public void testToString() {
        assertThat(ElectronicStabilityControlState.toString(ElectronicStabilityControlState.OTHER))
                .isEqualTo("OTHER");
        assertThat(
                        ElectronicStabilityControlState.toString(
    ...
    public void testAllElectronicStabilityControlStatesAreMappedInToString() {
        List<Integer> electronicStabilityControlStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(
                        ElectronicStabilityControlState.class);
        for (Integer electronicStabilityControlState : electronicStabilityControlStates) {
            String electronicStabilityControlStateString =
                    ElectronicStabilityControlState.toString(electronicStabilityControlState);
            assertWithMessage("%s starts with 0x", electronicStabilityControlStateString)
                    .that(electronicStabilityControlStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
