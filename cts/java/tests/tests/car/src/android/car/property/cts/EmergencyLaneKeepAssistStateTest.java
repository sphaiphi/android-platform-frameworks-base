...
public class EmergencyLaneKeepAssistStateTest {
    ...
    public void testToString() {
        ...
        assertThat(
                        EmergencyLaneKeepAssistState.toString(
        ...
        assertThat(EmergencyLaneKeepAssistState.toString(7)).isEqualTo("0x7");
        assertThat(EmergencyLaneKeepAssistState.toString(12)).isEqualTo("0xc");
    }

    @Test
    public void testAllEmergencyLaneKeepAssistStatesAreMappedInToString() {
        List<Integer> emergencyLaneKeepAssistStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(EmergencyLaneKeepAssistState.class);
        for (Integer emergencyLaneKeepAssistState : emergencyLaneKeepAssistStates) {
            ...
            assertWithMessage(
                            "string for mode %s must not start with 0x",
                            emergencyLaneKeepAssistStateString)
                    .that(emergencyLaneKeepAssistStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
