...
public class HandsOnDetectionWarningTest {
    ...
    public void testAllHandsOnDetectionWarningsAreMappedInToString() {
        List<Integer> handsOnDetectionWarnings =
                VehiclePropertyUtils.getIntegersFromDataEnums(HandsOnDetectionWarning.class);
        for (Integer handsOnDetectionWarning : handsOnDetectionWarnings) {
            ...
            assertWithMessage(
                            ...
                            handsOnDetectionWarningString)
                    .that(handsOnDetectionWarningString.startsWith("0x"))
                    .isFalse();
        }
    }
}
