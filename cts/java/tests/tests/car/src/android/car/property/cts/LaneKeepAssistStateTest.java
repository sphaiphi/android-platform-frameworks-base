...
public class LaneKeepAssistStateTest {
    ...
    public void testToString() {
        assertThat(LaneKeepAssistState.toString(LaneKeepAssistState.OTHER)).isEqualTo("OTHER");
        assertThat(LaneKeepAssistState.toString(LaneKeepAssistState.ENABLED)).isEqualTo("ENABLED");
    ...
    public void testAllLaneKeepAssistStatesAreMappedInToString() {
        List<Integer> laneKeepAssistStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(LaneKeepAssistState.class);
        for (Integer laneKeepAssistState : laneKeepAssistStates) {
            ...
            assertWithMessage("%s starts with 0x", laneKeepAssistStateString)
                    .that(laneKeepAssistStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
