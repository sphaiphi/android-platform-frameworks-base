...
public class HandsOnDetectionDriverStateTest {
    ...
    public void testAllHandsOnDetectionDriverStatesAreMappedInToString() {
        List<Integer> handsOnDetectionDriverStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(HandsOnDetectionDriverState.class);
        for (Integer handsOnDetectionDriverState : handsOnDetectionDriverStates) {
            ...
            assertWithMessage(
                            ...
                            handsOnDetectionDriverStateString)
                    .that(handsOnDetectionDriverStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
