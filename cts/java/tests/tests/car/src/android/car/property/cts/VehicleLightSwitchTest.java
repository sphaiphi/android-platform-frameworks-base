...
public final class VehicleLightSwitchTest {
    ...
    public void testToString() {
        assertThat(VehicleLightSwitch.toString(VehicleLightSwitch.STATE_OFF))
                .isEqualTo("STATE_OFF");
        assertThat(VehicleLightSwitch.toString(VehicleLightSwitch.STATE_ON)).isEqualTo("STATE_ON");
    ...
    public void testAllVehicleLightSwitchesAreMappedInToString() {
        List<Integer> vehicleLightSwitches =
                VehiclePropertyUtils.getIntegersFromDataEnums(VehicleLightSwitch.class);
        for (Integer vehicleLightSwitch : vehicleLightSwitches) {
            ...
            assertWithMessage("%s starts with 0x", vehicleLightSwitchString)
                    .that(vehicleLightSwitchString.startsWith("0x"))
                    .isFalse();
        }
    }
}
