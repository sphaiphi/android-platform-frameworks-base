...
public class DriverDistractionStateTest {
    ...
    public void testToString() {
        assertThat(DriverDistractionState.toString(DriverDistractionState.OTHER))
                .isEqualTo("OTHER");
        assertThat(DriverDistractionState.toString(DriverDistractionState.NOT_DISTRACTED))
                .isEqualTo("NOT_DISTRACTED");
        assertThat(DriverDistractionState.toString(DriverDistractionState.DISTRACTED))
    ...
    public void testAllDriverDistractionStateStatesAreMappedInToString() {
        ...
        for (Integer driverDistractionState : driverDistractionStates) {
            String driverDistractionStateString =
                    DriverDistractionState.toString(driverDistractionState);
            assertWithMessage("%s starts with 0x", driverDistractionStateString)
                    .that(driverDistractionStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
