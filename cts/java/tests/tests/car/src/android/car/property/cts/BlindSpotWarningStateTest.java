...
public class BlindSpotWarningStateTest {
    ...
    public void testToString() {
        assertThat(BlindSpotWarningState.toString(BlindSpotWarningState.OTHER)).isEqualTo("OTHER");
    ...
    public void testAllBlindSpotWarningStatesAreMappedInToString() {
        List<Integer> blindSpotWarningStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(BlindSpotWarningState.class);
        for (Integer blindSpotWarningState : blindSpotWarningStates) {
            String blindSpotWarningStateString =
                    BlindSpotWarningState.toString(blindSpotWarningState);
            assertWithMessage("%s starts with 0x", blindSpotWarningStateString)
                    .that(blindSpotWarningStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
