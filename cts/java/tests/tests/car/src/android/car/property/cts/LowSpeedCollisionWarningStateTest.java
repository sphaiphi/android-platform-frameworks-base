...
public class LowSpeedCollisionWarningStateTest {
    ...
    public void testToString() {
        assertThat(LowSpeedCollisionWarningState.toString(LowSpeedCollisionWarningState.OTHER))
                .isEqualTo("OTHER");
        assertThat(LowSpeedCollisionWarningState.toString(LowSpeedCollisionWarningState.NO_WARNING))
                .isEqualTo("NO_WARNING");
        assertThat(LowSpeedCollisionWarningState.toString(LowSpeedCollisionWarningState.WARNING))
                .isEqualTo("WARNING");
    ...
    public void testAllLowSpeedCollisionWarningStatesAreMappedInToString() {
        ...
        for (Integer lowSpeedCollisionWarningState : lowSpeedCollisionWarningStates) {
            String lowSpeedCollisionWarningStateString =
                    LowSpeedCollisionWarningState.toString(lowSpeedCollisionWarningState);
            assertWithMessage("%s starts with 0x", lowSpeedCollisionWarningStateString)
                    .that(lowSpeedCollisionWarningStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
