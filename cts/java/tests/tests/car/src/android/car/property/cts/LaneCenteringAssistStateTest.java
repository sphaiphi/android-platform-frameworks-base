...
public class LaneCenteringAssistStateTest {
    ...
    public void testToString() {
        ...
        assertThat(
                        LaneCenteringAssistState.toString(
    ...
    public void testAllLaneCenteringAssistStatesAreMappedInToString() {
        List<Integer> laneCenteringAssistStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(LaneCenteringAssistState.class);
        for (Integer laneCenteringAssistState : laneCenteringAssistStates) {
            String laneCenteringAssistStateString =
                    LaneCenteringAssistState.toString(laneCenteringAssistState);
            assertWithMessage("%s starts with 0x", laneCenteringAssistStateString)
                    .that(laneCenteringAssistStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
