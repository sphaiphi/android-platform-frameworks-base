...
public class DriverDrowsinessAttentionStateTest {
    ...
    public void testToString() {
        assertThat(DriverDrowsinessAttentionState.toString(DriverDrowsinessAttentionState.OTHER))
                .isEqualTo("OTHER");
        assertThat(
    ...
    public void testAllDriverDrowsinessAttentionStatesAreMappedInToString() {
        ...
        for (Integer driverDrowsinessAttentionState : driverDrowsinessAttentionStates) {
            String driverDrowsinessAttentionStateString =
                    DriverDrowsinessAttentionState.toString(driverDrowsinessAttentionState);
            assertWithMessage("%s starts with 0x", driverDrowsinessAttentionStateString)
                    .that(driverDrowsinessAttentionStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
