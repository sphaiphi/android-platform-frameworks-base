...
public class CrossTrafficMonitoringWarningStateTest {
    ...
    public void testToString() {
        assertThat(
                        CrossTrafficMonitoringWarningState.toString(
    ...
    public void testAllCrossTrafficMonitoringWarningStatesAreMappedInToString() {
        List<Integer> crossTrafficMonitoringWarningStates =
                VehiclePropertyUtils.getIntegersFromDataEnums(
                        CrossTrafficMonitoringWarningState.class);
        for (Integer crossTrafficMonitoringWarningState : crossTrafficMonitoringWarningStates) {
            ...
            assertWithMessage("%s starts with 0x", crossTrafficMonitoringWarningStateString)
                    .that(crossTrafficMonitoringWarningStateString.startsWith("0x"))
                    .isFalse();
        }
    }
}
