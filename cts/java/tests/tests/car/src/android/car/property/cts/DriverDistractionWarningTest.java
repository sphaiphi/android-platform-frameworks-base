...
public class DriverDistractionWarningTest {
    ...
    public void testToString() {
        assertThat(DriverDistractionWarning.toString(DriverDistractionWarning.OTHER))
                .isEqualTo("OTHER");
        assertThat(DriverDistractionWarning.toString(DriverDistractionWarning.NO_WARNING))
                .isEqualTo("NO_WARNING");
        assertThat(DriverDistractionWarning.toString(DriverDistractionWarning.WARNING))
                .isEqualTo("WARNING");
    ...
    public void testAllDriverDistractionWarningsAreMappedInToString() {
        List<Integer> driverDistractionWarnings =
                VehiclePropertyUtils.getIntegersFromDataEnums(DriverDistractionWarning.class);
        for (Integer driverDistractionWarning : driverDistractionWarnings) {
            ...
            assertWithMessage(
                    ...
                    .that(driverDistractionWarningString.startsWith("0x"))
                    .isFalse();
        }
    }
}
