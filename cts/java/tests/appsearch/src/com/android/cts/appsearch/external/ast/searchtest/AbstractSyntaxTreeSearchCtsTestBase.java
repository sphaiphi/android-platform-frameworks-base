...
public abstract class AbstractSyntaxTreeSearchCtsTestBase {
    ...
    public void testPropertyRestrictNode_toString_handlesMultipleTerms() throws Exception {
        ...
        AppSearchEmail fooBarFrom =
                new AppSearchEmail.Builder("namespace", "id1").setFrom("foo bar").build();
        AppSearchEmail fooBodyEmail =
                new AppSearchEmail.Builder("namespace", "id2").setBody("foo bar").build();
        ...
        PropertyRestrictNode propertyRestrictNode =
                new PropertyRestrictNode(new PropertyPath("body"), fooBar);
    ...
    public void testPropertyRestrictNode_toString_handlesMultipleTerms_prefixed() throws Exception {
        ...
        PropertyRestrictNode propertyRestrictNode =
                new PropertyRestrictNode(new PropertyPath("body"), fooB);
