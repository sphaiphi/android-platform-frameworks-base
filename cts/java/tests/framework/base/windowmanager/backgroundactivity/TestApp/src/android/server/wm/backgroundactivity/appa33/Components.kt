...
package android.server.wm.backgroundactivity.appa33
...
/** Constants for background activity test components in appa33. */
object Components : ComponentsProvider() {

    @JvmField val APP_A_33_PACKAGE_NAME = packageName

    @JvmField val APP_A_33_TEST_SERVICE = component(APP_A_TEST_SERVICE.className)

    @JvmField val APP_A_33_BACKGROUND_ACTIVITY = component(APP_A_BACKGROUND_ACTIVITY.className)

    @JvmField val APP_A_33_FOREGROUND_ACTIVITY = component(APP_A_FOREGROUND_ACTIVITY.className)

    object ForegroundActivityAction {
        @JvmField
        val APP_A_33_LAUNCH_BACKGROUND_ACTIVITIES =
