...
/** Constants for TV test app components. */
object Components : ComponentsProvider() {

    @JvmField val TV_PIP_ACTIVITY = component("PipActivity")

    @JvmField val TV_LAUNCH_ENTER_PIP_ACTIVITY = component("LaunchEnterPipActivity")
