...
/** Constants for unset ignoring orientation request test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_IGNORING_ORIENTATION_REQUEST_WHEN_LOOP_DETECTED_UNSET_ACTIVITY =
        component("AllowIgnoringOrientationRequestWhenLoopDetectedUnsetActivity")
