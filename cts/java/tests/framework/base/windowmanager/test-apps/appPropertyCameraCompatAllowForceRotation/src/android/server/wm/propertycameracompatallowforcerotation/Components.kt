...
/** Constants for camera compat allow force rotation test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val CAMERA_COMPAT_ALLOW_FORCE_ROTATION_ACTIVITY =
        component("CameraCompatAllowForceRotationActivity")
