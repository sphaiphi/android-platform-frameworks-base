...
/** Constants for allow resizeable activity overrides opt out test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_RESIZEABLE_ACTIVITY_OVERRIDES_OPT_OUT_ACTIVITY =
        component("AllowResizeableActivityOverridesOptOutActivity")
