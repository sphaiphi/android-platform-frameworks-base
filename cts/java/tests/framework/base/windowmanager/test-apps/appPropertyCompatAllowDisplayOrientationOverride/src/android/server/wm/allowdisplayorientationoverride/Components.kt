...
/** Constants for allow display orientation override test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_DISPLAY_ORIENTATION_OVERRIDE_ACTIVITY =
        component("AllowDisplayOrientationOverrideActivity")
