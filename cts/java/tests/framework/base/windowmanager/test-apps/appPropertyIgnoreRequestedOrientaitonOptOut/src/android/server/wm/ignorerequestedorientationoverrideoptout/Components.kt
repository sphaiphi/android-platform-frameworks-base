...
/** Constants for the ignore requested orientation override opt-out test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val OPT_OUT_CHANGE_ORIENTATION_WHILE_RELAUNCHING_ACTIVITY =
        component("ChangeOrientationWhileRelaunchingActivity")
