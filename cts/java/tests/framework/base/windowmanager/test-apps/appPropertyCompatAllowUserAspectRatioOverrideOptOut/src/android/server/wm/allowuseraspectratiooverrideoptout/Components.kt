...
/** Constants for user aspect ratio override opt out test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_USER_ASPECT_RATIO_OVERRIDE_OPT_OUT_ACTIVITY =
        component("AllowUserAspectRatioOverrideOptOutActivity")
