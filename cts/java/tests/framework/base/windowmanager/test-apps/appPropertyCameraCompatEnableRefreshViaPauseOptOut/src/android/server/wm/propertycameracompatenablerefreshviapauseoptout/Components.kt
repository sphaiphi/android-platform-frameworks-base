...
/** Constants for camera compat enable refresh via pause opt-out test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val CAMERA_COMPAT_ENABLE_REFRESH_VIA_PAUSE_OPT_OUT_ACTIVITY =
        component("CameraCompatEnableRefreshViaPauseOptOutActivity")
