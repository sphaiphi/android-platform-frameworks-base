...
/** Constants for allow user aspect ratio fullscreen override opt-in test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_USER_ASPECT_RATIO_FULLSCREEN_OVERRIDE_OPT_IN_ACTIVITY =
        component("AllowUserAspectRatioFullscreenOverrideOptInActivity")
