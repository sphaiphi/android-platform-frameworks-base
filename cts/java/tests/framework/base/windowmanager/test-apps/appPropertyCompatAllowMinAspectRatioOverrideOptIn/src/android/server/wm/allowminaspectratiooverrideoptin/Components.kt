...
/** Constants for opt-in minimum aspect ratio override test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_MIN_ASPECT_RATIO_OVERRIDE_OPT_IN_ACTIVITY =
        component("AllowMinAspectRatioOverrideOptInActivity")
