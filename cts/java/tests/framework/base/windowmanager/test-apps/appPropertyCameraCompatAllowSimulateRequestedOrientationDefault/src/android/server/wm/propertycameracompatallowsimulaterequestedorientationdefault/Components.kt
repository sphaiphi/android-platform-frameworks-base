...
/** Constants for camera compat allow simulate requested orientation test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val CAMERA_COMPAT_ALLOW_SIMULATE_REQUESTED_ORIENTATION_DEFAULT_ACTIVITY =
        component("CameraCompatAllowSimulateRequestedOrientationDefaultActivity")
