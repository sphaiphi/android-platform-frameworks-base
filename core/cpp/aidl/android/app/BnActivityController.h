...
namespace android {
namespace app {
class BnActivityController : public ::ndk::BnCInterface<IActivityController> {
public:
  BnActivityController();
  virtual ~BnActivityController();
protected:
  ::ndk::SpAIBinder createBinder() override;
private:
};
class IActivityControllerDelegator : public BnActivityController {
public:
  explicit IActivityControllerDelegator(const std::shared_ptr<IActivityController> &impl) : _impl(impl) {
  }
  ...
  ::ndk::ScopedAStatus activityStarting(const ::aidl::android::content::Intent& in_intent, const std::string& in_pkg, bool* _aidl_return) override {
    return _impl->activityStarting(in_intent, in_pkg, _aidl_return);
  }
  ::ndk::ScopedAStatus activityResuming(const std::string& in_pkg, bool* _aidl_return) override {
    return _impl->activityResuming(in_pkg, _aidl_return);
  }
  ::ndk::ScopedAStatus appCrashed(const std::string& in_processName, int32_t in_pid, const std::string& in_shortMsg, const std::string& in_longMsg, int64_t in_timeMillis, const std::string& in_stackTrace, bool* _aidl_return) override {
    return _impl->appCrashed(in_processName, in_pid, in_shortMsg, in_longMsg, in_timeMillis, in_stackTrace, _aidl_return);
  }
  ::ndk::ScopedAStatus appEarlyNotResponding(const std::string& in_processName, int32_t in_pid, const std::string& in_annotation, int32_t* _aidl_return) override {
    return _impl->appEarlyNotResponding(in_processName, in_pid, in_annotation, _aidl_return);
  }
  ::ndk::ScopedAStatus appNotResponding(const std::string& in_processName, int32_t in_pid, const std::string& in_processStats, int32_t* _aidl_return) override {
    return _impl->appNotResponding(in_processName, in_pid, in_processStats, _aidl_return);
  }
  ::ndk::ScopedAStatus systemNotResponding(const std::string& in_msg, int32_t* _aidl_return) override {
    return _impl->systemNotResponding(in_msg, _aidl_return);
  }
protected:
private:
  std::shared_ptr<IActivityController> _impl;
};
