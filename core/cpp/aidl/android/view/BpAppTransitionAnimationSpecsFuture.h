...
namespace android {
namespace view {
class BpAppTransitionAnimationSpecsFuture : public ::ndk::BpCInterface<IAppTransitionAnimationSpecsFuture> {
public:
  explicit BpAppTransitionAnimationSpecsFuture(const ::ndk::SpAIBinder& binder);
  virtual ~BpAppTransitionAnimationSpecsFuture();
